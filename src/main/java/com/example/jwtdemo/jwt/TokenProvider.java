...
public class TokenProvider implements InitializingBean {
    ...
    public TokenProvider(
        ...
        this.secret = secret;
        this.tokenValidInMilliseconds = tokenValidityInSeconds * 1000;
    }

    @Override // 빈이 생성이 되고 주입을 받은 후에 secret 값을 Base64 Decode 해서 Key 변수에 할당
    ...
    // 토큰을 파싱해보고 발생하는 예외 캐치, 문제잇으면 false, 정상이면 true
